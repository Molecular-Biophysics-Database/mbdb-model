...
python3 yamale2oarepo.py ../models/main/general_parameters.yaml \
        ../models/oarepo/general_parameters.yaml

python3 yamale2oarepo.py ../models/main/BLI.yaml ../models/oarepo/BLI.yaml \
        --include ../models/main/general_parameters.yaml

python3 yamale2oarepo.py ../models/main/MST.yaml ../models/oarepo/MST.yaml \
        --include ../models/main/general_parameters.yaml

python3 yamale2oarepo.py ../models/main/SPR.yaml ../models/oarepo/SPR.yaml \
        --include ../models/main/general_parameters.yaml
